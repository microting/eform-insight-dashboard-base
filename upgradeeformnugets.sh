...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add Microting.InsightDashboardBase/Microting.InsightDashboardBase.csproj package Microting.eForm
	dotnet add Microting.InsightDashboardBase/Microting.InsightDashboardBase.csproj package Microting.eFormApi.BasePn
